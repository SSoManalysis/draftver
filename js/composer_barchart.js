...
window.renderComposerBornYearChart = function() {
    ...
    chartSection.innerHTML = '<h3 class="section-title">Composer by Sex</h3><div id="bubbleBarChart" style="display: flex; flex-direction: column; align-items: center; overflow-y: auto; width: 100%;"></div>';
